...
const MessagesPage = () => {
  ...
  // Mock conversations with real roommate data
  const mockConversations: Conversation[] = MOCK_ROOMMATES.slice(0, 4).map((roommate, index) => ({
    id: `conv-${roommate.id}`,
    participant: {
      id: roommate.id,
      name: roommate.name,
  ...
  const mockMessages: Message[] = [
    {
      id: "1",
      senderId: mockConversations[0]?.participant.id || "1",
      receiverId: user.id,
      content: "Hi! I saw your profile and think we'd be a great match as roommates!",
    ...
    },
    {
      id: "2",
      senderId: user.id,
      receiverId: mockConversations[0]?.participant.id || "1",
