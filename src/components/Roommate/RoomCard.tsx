...
const RoomCard: React.FC<RoomCardProps> = ({ room }) => {
  ...
  // If room doesn't have images, add our placeholder images with the new uploaded image first
  if (!room.images || room.images.length === 0) {
    room.images = [defaultImages[0]]; // Always use the uploaded image first
  } else if (!room.images.some(img => img.includes("af57e138-9d54-4d23-a21a-9bf49734340c"))) {
    // Add the new image to the beginning of the array if it's not already there
    room.images.unshift("/lovable-uploads/af57e138-9d54-4d23-a21a-9bf49734340c.png");
  }
